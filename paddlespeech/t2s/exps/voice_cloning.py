...
def voice_cloning(args):
    ...
    for name in os.listdir(input_dir):
        ...
        if args.use_ecapa:
            spk_emb = vec_executor(model='ecapatdnn_voxceleb12',
            config='sv0_ecapa_tdnn_voxceleb12_ckpt_0_2_1/conf/model.yaml',
            ckpt_path='sv0_ecapa_tdnn_voxceleb12_ckpt_0_2_1/model/model',
            audio_file=ref_audio_path, force_yes=True)
            print(spk_emb.shape)
